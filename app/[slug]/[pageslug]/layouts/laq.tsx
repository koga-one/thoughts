...
export default function laq({ post }: { post: any }) {
  ...
  return (
    <section className="prose mx-auto overflow-hidden rounded-xl bg-[#000]">
      ...
      <div className="prose-base relative mx-auto p-3 text-[#eee] prose-headings:font-serif prose-headings:text-[#eee] prose-p:min-h-[1rem] prose-p:leading-5 prose-strong:text-[#eee] sm:p-4 md:p-5 lg:prose-lg">
